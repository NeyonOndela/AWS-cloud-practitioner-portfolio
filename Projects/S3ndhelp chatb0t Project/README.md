...
I developed **S3ndHelp**, an interactive chatbot using Amazon Web Services **Lex** and **Lambda**
...
I included screenshots of the chatbot and quiz interaction in the `screenshots`[Screenshots](https://github.com/NeyonOndela/AWS-cloud-practitioner-portfolio/blob/3ca93ce7878e6f63ef288fcc0e854c933f76b428/Projects/Sendhelp%20chatb0t%20Project/screents/screenshots.md)     folder.
...
Through the **S3ndHelp chatbot**, I demonstrated how Amazon Lex and lambda can be used together to build interactive and educational AI solutions.
